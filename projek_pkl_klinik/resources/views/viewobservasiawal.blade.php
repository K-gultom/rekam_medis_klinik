@extends('mainmenu')
@section('title')
    Lihat Data Observasi Awal
@endsection 

@section('contentmenu')
<div class="container-fluid">
    <h4 class="mb-2">Lihat Data Observasi Awal</h4>
    <nav aria-label="breadcrumb" class="mb-1">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('observasiawal')}}">Observasi Awal</a></li>
        <li class="breadcrumb-item active" aria-current="page">Lihat Data Observasi Awal</li>
      </ol>
    </nav>
    <div class="card">
        ...
        <div class="card-body">
            <form action="#" method="post">
              ...
              <a href="{{url('observasiawal')}}" class="btn btn-primary col-1">Kembali</a>
